class selenium_md_oracledb::oracle::exec::initializationdata::constantes::brasil::orgaoconcedente {
	...
	exec {'insert_orgao_concedente':
		command     => "sqlplus ${selenium_md_oracledb::systemusr}/${selenium_md_oracledb::systempass} as sysdba @orgao_concedente.sql > insert_orgao_concedente.log",
		...
		unless      => "test -f insert_orgao_concedente.log",
		timeout     => 0
	} 
}